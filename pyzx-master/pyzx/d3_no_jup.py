...
.div2 {
  ...
  height: 200px;
    ...
    <body>
    <div class="div2"></div>
<div  class="div1" style="overflow:auto" """ +""" id="graph-output-{0}" """.format(seq) +"""/div>
    <script src="require.js"></script>
    <script type="text/javascript">
    //window.languagePluginUrl = 'https://pyodide.cdn.iodide.io/pyodide';
     require.config({
            paths: {
                    "d3": "d3.v4.min",
                    "pyzx": "pyzx",
                    "pyodid": "https://pyodide.cdn.iodide.io/pyodide" //This is a CDN and could be unstable, long term should be changed to local files pyodide.js
                    }
            });
                """
