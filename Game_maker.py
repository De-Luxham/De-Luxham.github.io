...
html = zx.d3_no_jup.draw(graph)
f = open(r"web/graph_test_copy.html", "w")
f.write(html)
f.close()
url = os.getcwd()+ 'web/graph_test_copy.html'   #This automatically opens the graph in a chrome tab ready to be altered
